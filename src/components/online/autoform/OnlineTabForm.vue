  ...
  <div>
    <a-form style="margin-top: 8px" :form="form">
      <j-form-container :disabled="online_form_disabled">
        <online-tab-form-item :properties="rootProperties" slot="detail"></online-tab-form-item>
      </j-form-container>
    </a-form>
...
<script>
  import OnlineTabFormItem from './OnlineTabFormItem.vue'
  ...
  export default {
    ...
    methods:{
        ...
        if (properties){
          Object.keys(properties).map((key) => {
            ...
            if(item.view=='tab'){
              ...
              fp.validateCheckRule = validateCheckRule;
      ...
      handleApplyRequest(formData){
        // JS增强：beforeSubmit
        this.cgButtonLinkHandler(formData,"beforeSubmit","js").then(() => {
      ...
      cgButtonLinkHandler(record,buttonCode,optType){
        if(optType=="js"){
          if(this.EnhanceJS[buttonCode]){
            return this.EnhanceJS[buttonCode](this,record)
          } else {
