...
import TabDateWidget from './view/TabDateWidget.vue';
import DatetimeWidget from './view/DatetimeWidget.vue';
import TabDatetimeWidget from './view/TabDatetimeWidget.vue';
import TextareaWidget from './view/TextareaWidget.vue';
import SelectWidget from './view/SelectWidget.vue';
import TabSelectWidget from './view/TabSelectWidget.vue';
...
import AmapWidget from './view/AmapWidget.vue'
...
export default {
  install(Vue) {
    ...
    widgetRegistry.register(WIDGET_PRE+'tab_date', TabDateWidget);
    //注册时间
    widgetRegistry.register(WIDGET_PRE+'datetime', DatetimeWidget);
    widgetRegistry.register(WIDGET_PRE+'tab_datetime', TabDatetimeWidget);
    //注册多行文本
    widgetRegistry.register(WIDGET_PRE+'textarea', TextareaWidget);
    //注册下拉框
    widgetRegistry.register(WIDGET_PRE+'list', SelectWidget);
    widgetRegistry.register(WIDGET_PRE+'tab_list', TabSelectWidget);
    //注册 radio
    ...
    widgetRegistry.register(WIDGET_PRE+'amap', AmapWidget);
