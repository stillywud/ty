...
export default {
  ...
  mounted () {
    ...
    tinymce.init({
        selector:'#'+_this.id,
        // update-begin--Author:sunjianlei Date:20190929 for：此链接404，改成ant-design-jeecg-vue项目里的链接 -------------------------------
        language_url: this.$ls.get(BASE_URL) + '/tinymce/langs/zh_CN.js',
        // update-end--Author:sunjianlei Date:20190929 for：此链接404，改成ant-design-jeecg-vue项目里的链接 -------------------------------
        ...
        init_instance_callback: (editor) => {
          ...
          editor.on('input change undo redo', () => {
              _this.emitInput(editor.getContent())
          });
        },
        setup: (editor) => {
          editor.on(
