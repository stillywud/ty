    ...
    <div :id="`${caseId}inputTable`" class="input-table">
      ...
      <div class="scroll-view" ref="scrollView" :style="{'max-height':maxHeight+'px'}">
        ...
        <div :id="`${caseId}tbody`" class="tbody" :style="tbodyStyle">
          <!-- 扩展高度 -->
          <div class="tr-expand" :style="`height:${getExpandHeight}px;`"></div>
          <!-- 无数据时显示 -->
                  ...
                  <template v-for="(id,i) in [`${col.key}${row.id}`]">
                    ...
                    <label :key="i" v-if="col.type === formTypes.input || col.type === formTypes.inputNumber">
                      ...
                      >
                        ...
                        <input
                          :id="id"
                          :disabled="disabled || col.isReadOnly===1"
                          ...
                          <template v-if="col.allowDownload!==false || col.allowRemove!==false" slot="addonAfter" style="width: 30px">
                            <a-dropdown :trigger="['click']" placement="bottomRight" :getPopupContainer="getParentContainer">
                              ...
                              <a-menu slot="overlay">
                                ...
                                <a-menu-item v-if="col.allowRemove!==false" @click="handleClickDelFile(id)" :disabled="disabled || col.isReadOnly===1">
                          ...
                          <template style="width: 30px">
                            <a-dropdown :trigger="['click']" placement="bottomRight" :getPopupContainer="getParentContainer" style="margin-left: 10px;">
                              ...
                              <a-menu slot="overlay">
                                ...
                                <a-menu-item @click="handleClickDelFile(id)" :disabled="disabled || col.isReadOnly===1">
                                  <span><a-icon type="delete"/>&nbsp;删除</span>
                                </a-menu-item>
                                <a-menu-item @click="handleMoreOperation(id)" :disabled="disabled || col.isReadOnly===1">
                          ...
                          <template style="width: 30px">
                            <a-dropdown :trigger="['click']" placement="bottomRight" :getPopupContainer="getParentContainer" style="margin-left: 10px;">
                              ...
                              <a-menu slot="overlay">
                                ...
                                <a-menu-item @click="handleMoreOperation(id,'img')" :disabled="disabled || col.isReadOnly===1">
                                  <span><a-icon type="bars" /> 更多</span>
                                </a-menu-item>
                              </a-menu>
                            </a-dropdown>
                    ...
                    <!-- select搜索 -end -->
                    <!-- 开关switch -->
                  <template v-else-if="col.type === formTypes.switch">
                    <a-tooltip
                      :key="i"
                      :id="id"
                      placement="top"
                      ...
                      :getPopupContainer="getParentContainer">
                        ...
                        <j-switch
                          ...
                          v-bind="buildProps(row,col)"
                          style="width: 50px;"
                          :value="jswitchValues[id]"
                          :getCalendarContainer="getParentContainer"
                          :placeholder="replaceProps(col, col.placeholder)"
                          @change="(v)=>handleChangeSwitchCommon(v,id,row,col)"
                          >
                        </j-switch>
                      ...
                      <!-- 分类字典 -->
                      <template v-else-if="col.type === formTypes.cat_tree">
                        <a-tooltip
                          :key="i"
                          :id="id"
                          placement="top"
                          ...
                          :getPopupContainer="getParentContainer">
                            ...
                            <j-tree-select
                              ...
                              v-bind="buildProps(row,col)"
                              style="width: 100%;"
                              :value="jtreedictValues[id]"
                              :getCalendarContainer="getParentContainer"
                              :placeholder="replaceProps(col, col.placeholder)"
                              @change="(v)=>handleChangeTreeDictCommon(v,id,row,col)"
                        ...
                        <a-tooltip
                          ...
                          :getPopupContainer="getParentContainer">
                            ...
                            <j-tree-select
                              ...
                              v-bind="buildProps(row,col)"
                              style="width: 100%;"
                              :value="jseltreeValues[id]"
                              :getCalendarContainer="getParentContainer"
                              :placeholder="replaceProps(col, col.placeholder)"
                              @change="(v)=>handleChangeSelTreeCommon(v,id,row,col)"
                              :dict="col.dict"
                          ...
                          <a-tooltip
                            ...
                            :getPopupContainer="getParentContainer">
                              <j-select-user-by-dep
                                ...
                                v-bind="buildProps(row,col)"
                                style="width: 100%;"
                                :value="jseluserValues[id]"
                                :getCalendarContainer="getParentContainer"
                                :placeholder="replaceProps(col, col.placeholder)"
                                @change="(v)=>handleChangeSelUserCommon(v,id,row,col)"
                                >
                                </j-select-user-by-dep>
                          </a-tooltip>
                        </template>
                        <!--省市区-->
                        <template v-else-if="col.type === formTypes.pca">
                          <a-tooltip
                            :key="i"
                            :id="id"
                            placement="top"
                            ...
                            :getPopupContainer="getParentContainer">
                              <j-area-linkage
                                ...
                                :getCalendarContainer="getParentContainer"
                                :placeholder="replaceProps(col, col.placeholder)"
                                @change="(v)=>handleChangePcaCommon(v,id,row,col)"
                                >
                                </j-area-linkage>
                          </a-tooltip>
                        </template>
                            ...
                            <a-tooltip
                              ...
                              :getPopupContainer="getParentContainer">
                                <j-select-depart
                                  ...
                                  v-bind="buildProps(row,col)"
                                  style="width: 100%;"
                                  :value="jseldepartValues[id]"
                                  :getCalendarContainer="getParentContainer"
                                  :placeholder="replaceProps(col, col.placeholder)"
                                  @change="(v)=>handleChangeSelDepartCommon(v,id,row,col)"
                                  >
                                  </j-select-depart>
                            </a-tooltip>
                          </template>
...
<script>
  ...
  export default {
    name: 'JEditableTable',
    components: { JDate, Draggable, JInputPop, JFilePop, JSwitch, JTreeDict, JTreeSelect, JSelectUserByDep, JSelectDepart, JAreaLinkage},
    provide() {
      return {
    ...
    mounted() {
      ...
      console.log(this.dataSource,55534343)
    },
    methods: {
      ...
      initialize() {
        ...
        if (!this.isFirst) {
          ...
          this.jswitchValues = {}
          this.jtreedictValues = {}
          this.jseltreeValues={}
          this.jseluserValues = {}
          this.jpcaValues = {}
          this.jseldepartValues = {}
          this.slotValues = {}
          this.selectedRowIds = []
          this.tooltips = {}
          this.notPassedIds = []
      ...
      _pushByDataSource(dataSource, insertIndexes = null, update = true, rows = null, setDefaultValue = false) {
        ...
        let jswitchValues = { ...this.jswitchValues }
        let jtreedictValues = { ...this.jtreedictValues }
        let jseltreeValues = { ...this.jseltreeValues }
        let jseluserValues = { ...this.jseluserValues }
        let jpcaValues = { ...this.jpcaValues }
        let jseldepartValues = { ...this.jseldepartValues }
        ...
        dataSource.forEach((data, newValueIndex) => {
          ...
          this.columns.forEach(column => {
            ...
            } else if (column.type === FormTypes.switch) {
              jswitchValues[inputId] = sourceValue
            } else if (column.type === FormTypes.cat_tree) {
              jtreedictValues[inputId] = sourceValue
            }  else if (column.type === FormTypes.sel_tree) {
              jseltreeValues[inputId] = sourceValue
            } else if (column.type === FormTypes.sel_user) {
              jseluserValues[inputId] = sourceValue
            } else if (column.type === FormTypes.pca) {
              jpcaValues[inputId] = sourceValue
            } else if (column.type === FormTypes.sel_depart) {
              jseldepartValues[inputId] = sourceValue
          ...
          console.log(this.inputValues,909090)
        })
        // 启用了拖动排序，就重新计算排序编号
        if (this.dragSort) {
        ...
        this.jswitchValues = jswitchValues
        this.jtreedictValues = jtreedictValues
        this.jseltreeValues = jseltreeValues
        this.jseluserValues = jseluserValues
        this.jpcaValues = jpcaValues
        this.jseldepartValues = jseldepartValues
        ...
        console.log(this.getElement('tbody'),'tbody')
        if (update) {
          this.rows = rows
          // 更新form表单的值
          this.$nextTick(() => {
        ...
        for (let value of inputValues) {
          ...
          this.columns.forEach(column => {
            ...
            if (column.type === FormTypes.checkbox) {
              ...
              value[column.key] = this.jswitchValues[inputId]

            } else if (column.type === FormTypes.cat_tree) {
              value[column.key] = this.jtreedictValues[inputId]

            } else if (column.type === FormTypes.sel_tree) {
              value[column.key] = this.jseltreeValues[inputId]

            } else if (column.type === FormTypes.sel_user) {
              value[column.key] = this.jseluserValues[inputId]

            } else if (column.type === FormTypes.pca) {
              value[column.key] = this.jpcaValues[inputId]

            } else if (column.type === FormTypes.sel_depart) {
              value[column.key] = this.jseldepartValues[inputId]
      ...
      _getAllValuesForSlot() {
        return cloneObject({
          ...
          jswitchValues:this.jswitchValues,
          jtreedictValues:this.jtreedictValues,
          jseltreeValues:this.jseltreeValues,
          jseluserValues:this.jseluserValues,
          jpcaValues:this.jpcaValues,
          jseldepartValues:this.jseldepartValues,
          ...
          for (let newValueKey in newValues) {
            if (newValues.hasOwnProperty(newValueKey)) {
              ...
              if (!edited) {
               ...
               // 在 jswitchvalues 中寻找值
               if (!edited) {
                edited = this.setOneValue(this.jswitchValues, modelKey, newValue)
              }
              // 在 jtreedictvalues 中寻找值
              if (!edited) {
                edited = this.setOneValue(this.jtreedictValues, modelKey, newValue)
              }
              // 在 jseltreeValues 中寻找值
              if (!edited) {
                edited = this.setOneValue(this.jseltreeValues, modelKey, newValue)
              }
              // 在 jseluserValues 中寻找值
              if (!edited) {
                edited = this.setOneValue(this.jseluserValues, modelKey, newValue)
              }
              // 在 jpcaValues 中寻找值
              if (!edited) {
                edited = this.setOneValue(this.jpcaValues, modelKey, newValue)
              }
              // 在 jseldepartValues 中寻找值
              if (!edited) {
                edited = this.setOneValue(this.jseldepartValues, modelKey, newValue)
              }
              // 在 slotValues 中寻找值
              if (!edited) {
      ...
      handleChangeSwitchCommon(value,id,row,column){
        this.jswitchValues = this.bindValuesChange(value, id, 'jswitchValues')

        this.validateOneInput(value, row, column, this.notPassedIds, true, 'change')

        this.elemValueChange(FormTypes.switch, row, column, value)
      },
      //分类字典数值
      handleChangeTreeDictCommon(value,id,row,column){
        this.jtreedictValues = this.bindValuesChange(value, id, 'jtreedictValues')

        this.validateOneInput(value, row, column, this.notPassedIds, true, 'change')

        this.elemValueChange(FormTypes.cat_tree, row, column, value)
      },
      //自定义树数值
      handleChangeSelTreeCommon(value,id,row,column){
        this.jseltreeValues = this.bindValuesChange(value, id, 'jseltreeValues')
       ...
       //用户
       handleChangeSelUserCommon(value,id,row,column){
        this.jseluserValues = this.bindValuesChange(value, id, 'jseluserValues')
       ...
       //pca
       handleChangePcaCommon(value,id,row,column){
        this.jpcaValues = this.bindValuesChange(value, id, 'jpcaValues')

        this.validateOneInput(value, row, column, this.notPassedIds, true, 'change')

        this.elemValueChange(FormTypes.pca, row, column, value)
      },
       //部门
       handleChangeSelDepartCommon(value,id,row,column){
        this.jseldepartValues = this.bindValuesChange(value, id, 'jseldepartValues')
      ...
      getUploadAction(value) {
        if (!value) {
          return window._CONFIG['uploadURL'] + '/sys/common/upload'
        } else {
          return value
        }
      },
      ...
      /** popup回调 */
      popupCallback(value, othersArr, id, row, column, index) {
        for (let i = 0; i < othersArr.length; i++){
          let others = othersArr[i]
          if (i === 0){
            // 存储输入的值
              ...
              Object.keys(others).map((key) => {
                this.columns.map(k=>{
                  if(k.key === key){
                    ...
                    }else if(k.type === 'popup'){
                      this.popupValues[key+tempId] = others[key]
                    }else{
            ...
            // this.add()
            let newIndex = index++
            let rowId = this.rows[newIndex+1].id
            // let rowId = this.rows[this.rows.length-1].id
            if (others) {
              Object.keys(others).map((key) => {
                this.columns.map(k=>{
                  if(k.key === key){
                    ...
                    if(k.type === 'date'){
                      ...
                      this.inputValues[newIndex+1][key] = others[key]
                      // this.inputValues[this.rows.length-i][key] = others[key]
                    }
                  }
                })
              })
