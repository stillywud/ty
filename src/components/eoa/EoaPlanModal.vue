          ...
          <a-row style="width: 100%;">
            <a-col :span="12">
              <a-form-item
                ...
                label="日程标题">
                <a-input placeholder="请输入标题" :read-only="allReadOnly"
            ...
            <a-col :span="12">
              <a-form-item
                ...
                <j-dict-select-tag placeholder="请选择类型" type="select" :disabled="allReadOnly"
                                   v-decorator="[ 'type', validatorRules.type]" :trigger-change="true"
          ...
          <a-row style="width: 100%;">
            <a-col :span="12">
              <a-form-item
                ...
                :wrapperCol="wrapperColX2"
                label="提醒类型">
                <j-dict-select-tag placeholder="请选择提醒类型" type="select" :disabled="allReadOnly"
                                   v-decorator="[ 'remindType', validatorRules.remindType]"
            ...
            <a-col :span="12">
              <a-form-item
                ...
                :wrapperCol="wrapperColX2"
                label="紧急程度">
                <j-dict-select-tag placeholder="请选择紧急程度" type="select"
                                   v-decorator="[ 'urgentLevel', validatorRules.urgentLevel]"
          ...
          <a-row>
            <a-col :span="12">
              <a-form-item
                ...
                :wrapperCol="wrapperColX2"
                label="重复提醒">
                <j-dict-select-tag placeholder="请选择重复提醒" type="select"
                                   v-decorator="['reminders',validatorRules.isNotEmpty]"
                                   :trigger-change="true" dictCode="reminders" @change="handleChange"/>
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item
                ...
                :wrapperCol="wrapperColX2"
                label="提醒时间">
                <j-dict-select-tag placeholder="请选择提醒时间" type="select"
                                   v-decorator="['remind',validatorRules.isNotEmpty]"
                                   :trigger-change="true" dictCode="remindTime" :disabled="disableSubmit"/>
              </a-form-item>
            </a-col>
          </a-row>
          <a-row style="width: 100%;">
            <a-col :span="12">
              <a-form-item
                ...
                label="日程时间"
              >
                <a-range-picker v-bind="dateRangePickerProps" :disabled="allReadOnly"
                                v-decorator="[ 'rangeTime', validatorRules.rangeTime]"/>
              </a-form-item>
            </a-col>
            ...
            <a-col :span="12">
              <a-form-item
                ...
                :wrapperCol="wrapperColX2"
                label="是否全天">
                <j-checkbox :options="[{value:'1'}]" :disabled="allReadOnly"
                            v-decorator="['allDay', {}]" @change="allDayValue=$event"/>
              </a-form-item>
            </a-col>
          </a-row>
          ...
          <a-row>
            <a-col :span="24">
              <a-form-item
                ...
                :wrapperCol="wrapperColX2"
                label="url地址">
                <a-input placeholder="请输入url地址" :read-only="allReadOnly" dictCode="businessLink"
                         v-decorator="['businessLink', validatorRules.businessLink ]"/>
            ...
            <a-col :span="12">
              <a-form-item
                ...
                :wrapperCol="wrapperColX2"
                label="参与人">
                <j-select-user-by-dep v-decorator="['joinPerson', {}]"
...
export default {
  name: 'EoaPlanModal',
  components: {JCheckbox, JEditor, JSelectUserByDep, JMultiSelectTag, JDictSelectTag},
  props: ['isurl'],
  data() {
    return {
      title: '操作',
  ...
  methods: {
    ...
    edit(record, title = '变更日程计划') {
      ...
      if (record&&(JSON.stringify(record) !== '{}')&&(typeof (record) != 'string')) {
        this.model.businessLink = record.businessLink
      } else if ((typeof (record) == 'string') && this.isurl) {
        this.model.businessLink = window.location.href
      } else {
        this.model.businessLink = ''
      }
      this.$nextTick(() => {
        ...
        if (this.model.remindType) {
          conventValues['remindType'] = this.model.remindType
        }
    ...
    handleOk() {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          // 转换多选 select 的值
          formData.remindType = formData.remindType
