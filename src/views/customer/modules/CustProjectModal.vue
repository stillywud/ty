  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'customerUid','projectName','projectAddress','projectTypeId','projectStageId','projectInfo','projectStartdate','projectEnddate','lat','lon','accessSysId','payBankAccountAddress','payBankAccountTel'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'customerUid','projectName','projectAddress','projectTypeId','projectStageId','projectInfo','projectStartdate','projectEnddate','lat','lon','accessSysId','payBankAccountAddress','payBankAccountTel'))
      },
