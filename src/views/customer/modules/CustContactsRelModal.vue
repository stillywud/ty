  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'contactsUpUid','contactsDownUid','contactsRelTypeId','contactsUpPhone','customerUid','accessSysId'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'contactsUpUid','contactsDownUid','contactsRelTypeId','contactsUpPhone','customerUid','accessSysId'))
      },
