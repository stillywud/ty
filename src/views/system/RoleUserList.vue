      ...
      <a-card :bordered="false">
            ...
            <a-row :gutter="24">
              <a-col :md="6" :sm="8">
                <a-form-item label="应用系统" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
                  <j-search-select-tag v-model="queryParam.sysId" placeholder="请选择应用系统" dict="sys_info,name,id,deleted=0"/>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="8">
        ...
        <div style="margin-top: 15px">
          ...
          <span slot="action" slot-scope="text, record">
            ...
            <a-divider type="vertical" v-has="'role:workflow'"/>

            <a @click="handleDesign(record.id)" v-has="'role:workflow'">工单授权</a>
          ...
          <a-form layout="inline">
            ...
            <a-col :md="9" :sm="24">
             <a-button type="primary" @click="searchQuery2" icon="search" style="margin-left: 21px">查询</a-button>
              ...
              <a-button @click="handleAddUserRole" type="primary" icon="plus" style="margin-left: 8px">添加账号</a-button>
            </a-col>
          </span>
            </a-row>
          </a-form>
