  ...
  <a-row :gutter="10">
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        <div style="padding-left:16px;padding-bottom:15px;display: inline-block;border-radius: 0 0 2px 2px;">
          <div style="display: inline-block">组织架构:</div>
          <j-search-select-tag v-model="orgId" @change="handleChange"
                             placeholder="请选择组织架构"
                             dict="sys_organization,name,id,deleted=0" style="padding-left: 10px;width: 300px"/>
        </div>
        <!-- 按钮操作区域 -->
        <a-row style="margin-left: 14px">
          ...
          <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader"
                    :action="importExcelUrl" @change="handleImportExcel" :data="{'orgId':this.orgId}">
          ...
          <a-card :bordered="false" v-if="selectedKeys.length>0">
            <a-form :form="form">
              ...
              <a-form-item
                ...
                :wrapperCol="wrapperCol"
                label="部门简称">
                <a-input placeholder="请输入部门简称" v-decorator="['departNameEn', {}]"  />
              </a-form-item>
              <a-form-item
                :labelCol="labelCol"
                :wrapperCol="wrapperCol"
                label="部门缩写">
                <a-input placeholder="请输入部门缩写" v-decorator="['departNameAbbr', {}]"  />
              </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      handleAdd(num) {
        ...
        if (num == 1) {
          this.$refs.departModal.add(data)
          ...
          data.flag = this.selectedKeys
          this.$refs.departModal.add(data)
          this.$refs.departModal.title = '新增'
        } else {
          data.flag = this.rightClickSelectedKey
          this.$refs.departModal.add(data)
          this.$refs.departModal.title = '新增'
        }
      },
