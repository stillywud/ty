<template>
    <a-card :bordered="false" style="height: 100%">
        ...
        <div>
          ...
          <a-popover :overlayStyle="{maxWidth:'500px'}" title="自定义列" trigger="click" placement="leftBottom"
            ...
            <a-table
                ...
                <template slot="imgSlot" slot-scope="text">
                    ...
                    <img v-else :src="getImgView(text)" height="25px" alt="加载失败"
        ...
        watch: {
            $route: {
                ...
                handler(val) {
                    ...
                    if (val.path.indexOf('/online/cgformList/') === 0||val.path.indexOf('out/online/cgformList/') != -1) {
                        this.initAutoList()
                    }
                },
            },
        ...
        methods: {
            ...
            initAutoList() {
                ...
                getAction(`${this.url.getColumns}${this.code}`).then((res) => {
                    ...
                    console.log('-------0nline表单开发 无权限跳转404 ----------',res)

                   //  //0nline表单开发 无权限跳转404 by weina
                    if(res.code==500){
