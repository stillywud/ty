<template>
    <van-popup v-model="visible" round closeable :style="{'height':'90%','width':'90%','overflow':'auto','padding': '30px 12px'}">
...
<script>
  ...
  import OnlineFormApp from '@/components/online/autoform/OnlineFormApp.vue';
