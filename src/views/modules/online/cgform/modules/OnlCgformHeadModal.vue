                ...
                <a-row :gutter="gutter" style="width: 100%;">
                  <a-col :span="24/3">
                    <a-form-item
                      ...
                      :wrapperCol="{span:18}"
                      label="表名">
                      <a-input :readOnly="editPageFlag" placeholder="请输入表名"
                ...
                <a-row :gutter="gutter" style="width: 100%;" v-if="showRelationType">
                  ...
                  <a-col :span="3" :push="17">
                    <a-form-item
                      ...
                      label="序号">
                      <a-input-number style="width: 100%;" placeholder="请输入序号"
                                      v-decorator="[ 'tabOrderNum', validatorRules.tabOrderNum]"/>
                    </a-form-item>
                  </a-col>
                </a-row>
              </a-col>
            ...
            <a-row :gutter="gutter" style="width: 100%;">
              <a-col :span="24/3">
                <a-form-item
                  ...
                  <j-dict-select-tag dict-code="ol_form_biz_type"
                                     v-decorator="[ 'formCategory', {initialValue: 'temp'}]" :trigger-change="true"
            ...
            <a-row :gutter="gutter" style="width: 100%;">
              <a-col :span="24/3">
                <a-form-item
                  ...
                  :wrapperCol="threeCol.wrapper"
                  label="是否支持审批">
                  <a-select v-decorator="[ 'approveFlag', {initialValue: '0'}]">
              ...
              <a-col :span="24/3">
                <a-form-item
                  ...
                  :wrapperCol="threeCol.wrapper"
                  label="表单打开方式">
                  <a-select v-decorator="[ 'formOpenType', {initialValue: '0'}]">
                    <a-select-option value='0'>modal对话框</a-select-option>
                    <a-select-option value='1'>新页签</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
            </a-row>
      ...
      <a-spin :spinning="tableLoading">
        <a-tabs v-model="activeKey" @change="handleChangeInTabs">
          ...
          <a-tab-pane tab="查询配置" key="6" :forceRender="true">
            <query-table ref="table6" @query="queryFieldSetting" @syncQuery="syncQueryTable7"/>
          </a-tab-pane>
          <a-tab-pane tab="App列表配置" key="7" :forceRender="true">
            <app-config-table ref="table7" @syncQuery="syncQueryTable6"/>
          </a-tab-pane>
...
<script>
  ...
  import AppConfigTable from '../tables/AppConfigTable'
    ...
    methods: {
      ...
      add() {
        ...
        this.getAllTable().then(tables => {
          ...
          let [table1, table2, table3, table4, table5, table6, table7] = tables
          // 临时 id，不保存到数据库
          let tempIds = []
      ...
      edit(record, caller = '') {
        ...
        if (caller !== 'add') {
          ...
          Promise.all([
            ...
            this.getRefPromise('table7')
          ]).then(results => {
            let [{ result: fields }, table1, table2, table3, table4, table6, table7] = results
            table1.deleteIds = []
      ...
      handleChangeInTabs(activeKey) {
        ...
        if (['2', '3', '4', '5', '6', '7'].indexOf(activeKey) !== -1) {
          Promise.all([
            this.getRefPromise('table1'),
      ...
      classifyIntoFormData(options) {
        ...
        options.table1.values.forEach((item, index) => {
          ...
          let value7 = options.table7.values[index]
          field = Object.assign(value7, field)
      ...
      syncQueryTable7(row) {
        this.$refs.table7.setQueryValue(row)
      },
      syncQueryTable6(row) {
        this.$refs.table6.setQueryValue(row)
      }
    }
  }
</script>
