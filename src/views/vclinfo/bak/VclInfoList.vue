        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="品牌">
              <a-input placeholder="请输入品牌" v-model="queryParam.dictvbVclbrand"></a-input>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="机种">
                <a-input placeholder="请输入机种" v-model="queryParam.dictvkVclkind"></a-input>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="吨级">
                <a-input placeholder="请输入吨级" v-model="queryParam.dictvtonTon"></a-input>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="发动机型号">
                <a-input placeholder="请输入发动机型号" v-model="queryParam.vclEnginemodel"></a-input>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'品牌',
            align:"center",
            dataIndex: 'dictvbVclbrand_dictText'
          },
          {
            title:'机种',
            align:"center",
            dataIndex: 'dictvkVclkind_dictText'
          },
          {
            title:'吨级',
            align:"center",
            dataIndex: 'dictvtonTon_dictText'
          },
          {
            title:'机型',
            align:"center",
