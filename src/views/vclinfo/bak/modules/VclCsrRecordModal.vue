    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="客户" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['customerUid', validatorRules.customerUid]" :trigger-change="true" dictCode="" placeholder="请选择客户"/>
        </a-form-item>
        ...
        <a-form-item label="是否投保" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['isInsure', validatorRules.isInsure]" :trigger-change="true" dictCode="" placeholder="请选择是否投保"/>
        </a-form-item>
        <a-form-item label="保险类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['supInsureType']" :trigger-change="true" dictCode="" placeholder="请选择保险类型"/>
        </a-form-item>
