<template>
  <a-card :bordered="false" style="height:100%;padding-bottom:200px; ">
    <div style="width: 600px; margin-bottom: 10px;">
      <select-component-widget placeholder="请选择零件" @confirm="selectComponents" @cancel="selectComponents"/>
      <div>{{selectRows}}</div>
    </div>
      ...
      <a-form layout="inline" :form="form">
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item
                    label="地图">
              <MapInput @change="getNewPosition"></MapInput>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24">
...
<script>
  ...
  import JPopup from '@/components/online/autoform/comp/JPopup.vue'
  import JSearchSelectTag from '@/components/dict/JSearchSelectTag'
  import SelectComponentWidget from '../components/SelectComponentWidget'
  import MapInput from '@/components/map/mapInput.vue'
  import TyMap from '@/components/map/tyMap.vue'

  export default {
    name: 'SelectDemo',
    inject: ['closeCurrent'],
    components: {
      SelectComponentWidget,
      JMarkdownEditor,
      JAreaLinkage,
      JInput,
      JCategorySelect,
      ...
      JCron, JTreeSelect, JSuperQuery, JMultiSelectTag, JPopup,
      JSearchSelectTag,
        MapInput,
        TyMap
    },
