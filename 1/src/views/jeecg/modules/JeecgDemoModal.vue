  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        :wrapperCol="wrapperCol"
        label="地图">
          <MapInput @change="getNewPosition" v-model="item"></MapInput>
        </a-form-item> 
        <a-form-item
        :labelCol="labelCol"
        :wrapperCol="wrapperCol"
        label="驻点名称"
        >
          <a-input placeholder="" v-decorator="['mtitle', {}]" />
        </a-form-item>
        <a-form-item
        :labelCol="labelCol"
        :wrapperCol="wrapperCol"
        label="驻点描述"
        >
          <a-input placeholder="" v-decorator="['mdescription', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    methods: {
      getNewPosition(a){
          ...
          this.form.setFieldsValue({mtitle:obj.title})
          this.form.setFieldsValue({mdescription:obj.description})
      },
      add () {
        this.edit({});
      },
      edit (record) {
        let obj={pointer:'',description:'',title:''}
        this.item = JSON.stringify(obj);
        this.form.resetFields();
        this.model = Object.assign({}, record);
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','keyWord','sex','age','email','content','mtitle','mdescription'))
		      //时间格式化
