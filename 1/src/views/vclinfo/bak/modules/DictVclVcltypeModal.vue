    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="品牌id" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['dictvtDictvbId']" placeholder="请输入品牌id" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="机种id" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['dictvtDictvkId']" placeholder="请输入机种id" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="吨级id" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['dictvtDictvtonId']" placeholder="请输入吨级id" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="备注" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['dictvtRemark']" placeholder="请输入备注"></a-input>
        </a-form-item>
