  ...
  <div style="background: #ffffff">
    ...
    <a-card title="意见信息" :bodyStyle="{padding:'0 20px'}" size="default" style="margin-top:20px">
      <a-list itemLayout="vertical">
          ...
          <a-row>
            <a-col :span="24">
              <a-radio-group  v-model="model.processModel">
                ...
                <a-radio :value="2" :hidden="true">多分支模式</a-radio>
        ...
        <a-list-item>
          <a-checkbox style="display: none;" :checked="checkedNext" @change="handleCheckedNextChange">指定下一步操作人（指定下一步会签人员）</a-checkbox>
    ...
    data() {
      return {
        url: {
          ...
          upload:window._CONFIG['uploadURL'] + "/sys/common/upload"
        },
        headers: {},
        resultObj:{},
        checkedNext: false,
