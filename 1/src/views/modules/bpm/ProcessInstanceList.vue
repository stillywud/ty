        ...
        <span slot="action" slot-scope="text, record">
            ...
            <a-dropdown>
              ...
              <a-menu slot="overlay">
                ...
                <a-menu-item
                        v-if="record.isSuspended!=''&& record.isSuspended==='false'&& record.isSuspended!='finished'"><a
                        @click="selectEntruster(record)">委派</a></a-menu-item>
                <a-menu-item v-if="record.isSuspended!=''"><a
                        @click="handleSkipNode(record.taskId)">跳转</a></a-menu-item>
