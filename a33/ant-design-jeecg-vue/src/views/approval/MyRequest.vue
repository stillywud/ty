<template>
  <div>
    <!--新增审批-->
    <add-approval ref="addApproval" @save="addFinished"/>
    <a-card>
      <!-- 查询区域 -->
      ...
      <a-table
        ...
        <span slot="action" slot-scope="record">
          <div><a @click="handleView(record)">查看</a></div>
        </span>
      </a-table>
    </a-card>
    <!-- 审批start-->
...
<script>
  ...
  import { queryApplyList } from '@/api/approval.js'
  ...
  export default {
    ...
    methods: {
      ...
      searchQuery() {
        ...
        queryApplyList(this.searchForm).then((res) => {
          if (res.success == true) {
