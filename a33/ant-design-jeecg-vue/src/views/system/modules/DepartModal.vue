  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
          ...
          this.model.orgId = record.orgId
          this.visible = true;
          this.loadTreeData();
          this.model.parentId = record.flag!=null?record.flag.toString():null;
          if(this.seen){
          ...
          this.$nextTick(() => {
            this.form.setFieldsValue(pick(this.model,'orgCategory','departName','departNameEn','departNameAbbr','departOrder','description','orgType','orgCode','mobile','fax','address','memo','status','delFlag','orgId'))
          });
      },
      close () {
        this.$emit('close');
