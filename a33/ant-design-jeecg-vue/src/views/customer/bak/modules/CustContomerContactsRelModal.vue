  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'customerUid','contactsRelTypeId','contactsUpPhone','contactsPower','isCustomer','accessSysId','accessSysName','customerContactsRelStatus'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'customerUid','contactsRelTypeId','contactsUpPhone','contactsPower','isCustomer','accessSysId','accessSysName','customerContactsRelStatus'))
      },
