  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'customerUid','contactsName','contactsPhone','contactsPhone2','contactsGender','contactsHobby','contactsNation','contactsBronData','contactsIdTypeId','contactsNo','contactsPhotoUrl','accessSysId','accessSysName','contactsVerified','contactsInfoStatus'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'customerUid','contactsName','contactsPhone','contactsPhone2','contactsGender','contactsHobby','contactsNation','contactsBronData','contactsIdTypeId','contactsNo','contactsPhotoUrl','accessSysId','accessSysName','contactsVerified','contactsInfoStatus'))
      },
