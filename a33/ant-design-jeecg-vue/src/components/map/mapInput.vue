    ...
    watch:{
      ...
      value(val){
        ...
        if(val){
          ...
          this.tmpAddress = this.item.description;
          this.tmpLnglat = this.item.pointer;
        }
      },
      tmpAddress(val){
        this.tmpLnglat = val?this.tmpLnglat:'';
      ...
      addMakers(){
        ...
        let index=0;
          for(let i=0; i<this.lists.length; i++){
            let pointer = this.lists[i]['pointer']
            let pos = pointer.split(',');
