            ...
            <div class="con-box-wrapper">
                ...
                <div class="list-box">
                    ...
                    <a-form-model-item label="" prop="workingHoursLockTime"  class="item-0">
                        <a-input
                        @change="workingHoursLockTimeCallback"
                ...
                <div class="list-map" id="container11"></div>
            </div>
        </a-form-model>
    </div>
</div>
...
export default {
    ...
    mounted() {
        this.mapaliInit();
       "8" == this.recordData.vcl_dictsys_id && "8" == this.recordData.vcl_dictvb_id ? 
       this.carSrc = "./static/img/yhde.png" : 
       "4" == this.recordData.vcl_dictsys_id && "4" == this.recordData.vcl_dictvb_id ? 
       this.carSrc = "./static/img/beifang.png" : 
       "3" == this.recordData.vcl_dictsys_id && "3" == this.recordData.vcl_dictvb_id ? 
       this.carSrc = "./static/img/beifang.png" : 
       "5" == this.recordData.vcl_dictsys_id && "5" == this.recordData.vcl_dictvb_id ? 
       this.carSrc = "./static/img/beifang.png" : 
       "6" == this.recordData.vcl_dictsys_id && "6" == this.recordData.vcl_dictvb_id ? 
       this.carSrc = "./static/img/xiaosong.png" : 
       "9" == this.recordData.vcl_dictsys_id && "1" == this.recordData.vcl_dictvb_id ? 
       this.carSrc = "./static/img/xiaosong.png" : 
       "9" == this.recordData.vcl_dictsys_id && "7" == this.recordData.vcl_dictvb_id ? 
       this.carSrc = "./static/img/beifang.png" : 
       "10" == this.recordData.vcl_dictsys_id && "1" == this.recordData.vcl_dictvb_id && (this.carSrc = "./static/img/xiaosong.png"),
        this.getParaLast();
    },
    methods:{
        ...
        workingHoursLockTimeCallback(e){
            this.regexpcomOne(e.target.value,"workingHoursLockTime")
        },
        ...
        getParaLast(){
            getParaLast({
                vcl_id:this.recordData.vcl_id, // 机械ID 终端 vcl_id
                para_id:"TC_0001_00_1",
                page_size:10,
                page:1,
                sys_id:this.recordData.vcl_dictsys_id, // 用户id---vcl_dictsys_id
                brand_id:this.recordData.vcl_dictvb_id // 品牌ID---vcl_dictvb_id
            }).then((response)=>{
        ...
        addpoints: function(e) {
            ...
            i.mouseFunc = function(e) {
                let t = e.pointId.split("~")[1].split(",")[0]
                    , a = e.pointId.split(",")[1]
                    , r = (that.recordData.vcl_dictsys_id,
                that.recordData.vcl_dictvb_id,
