<template><!--/事件透传参数设置/-->
<div class="s-set-even-parameter-info-box">
    <div class="con-box">
...
import moSetEventParameterInfoS from "../modal/moSetEventParameterInfoS"
import TyASpin from "@/components/TyASpin"
import cloneDeep from "lodash/cloneDeep"
export default {
    name:"sSetEventParameterInfo",
    data() {
        return {
            tyspining:false,
                ...
                pgnCount:[{
                    ...
                    validator:(rule, value, callback)=>{
                        if(value === ""){
                            ...
                            if (pgnCount > 30 && pgnCount !== 255) {
                                callback(new Error("取值范围为0-30或255的整数"))
                            }else{
                                callback()
                            }
                        }
        ...
        addPackage() {
            ...
            if(pgnCount !== ""){
                ...
                if([0,255].includes(pgnCount)){
                    ...
                    this.$message.error("PGN参数ID个数：取值范围为0-30或255的整数")
