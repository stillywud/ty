<template><!--/  回叫指定参数组信息 /-->
<div class="s-callback-parametar-group-box">
    <div class="con-box">
        ...
        <a-form-model
            ...
            <div class="con-box-wrapper">
                ...
                <div class="checklist-0">
                    <a-checkbox-group v-model="setSubForm.paramGroupNo">
                        <a-form-model-item prop=""  class="item-0">
                            <a-checkbox value="2">回叫保养剩余</a-checkbox>
                        </a-form-model-item>
                        <a-form-model-item prop=""  class="item-0">
                            <a-checkbox value="3">间隔时间</a-checkbox>
                        </a-form-model-item>
                        <a-form-model-item prop=""  class="item-0">
                            <a-checkbox value="4">回叫初期设定数据</a-checkbox>
                        </a-form-model-item>
                        <a-form-model-item prop=""  class="item-0">
                            <a-checkbox value="5">回叫设备参数</a-checkbox>
                        </a-form-model-item>
                        <a-form-model-item prop=""  class="item-0">
                            <a-checkbox value="7">回叫设备状态</a-checkbox>
                        </a-form-model-item>
                    </a-checkbox-group>
                </div>
            </div>
...
export default {
    ...
    methods:{
        ...
        filerParams(obj){
            ...
            newObj.paramGroupNum = newObj.paramGroupNo.length;
            return newObj;
        },
        onSubmit(){
...
<style lang="scss">
    .s-callback-parametar-group-box{
        height: 500px;
        position: relative;
        .con-box{
            height: 500px;
