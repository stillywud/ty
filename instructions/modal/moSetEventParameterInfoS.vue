<template>
  <a-modal
    ...
    @ok="handleOk"
    @cancel="handleCancel"
    wrapClassName="plugins-set-parametarrealtime-modal"
    cancelText="关闭">
      ...
      <a-form-model ref="ruleForm" :model="packForm" :rules="packRules" >
        ...
        <div class="list-0">
            ...
            <a-form-model-item  class="item-0" label="PGN ID"  prop="pgnId">
                <a-input 
                    placeholder="请输入PGN ID，如00000000"  
...
let packFormCopy = {
    ...
    pgnId:0,
    frequency:0,
    multiRadioFrameFormat:0,
    multiRadioId:0,
    multiDataFrameFormat:0,
    mutiDataId:0,
    dataIdBegin:0,
    dataIdLength:0,
    dataId:""
...
import {frameFormats, isPackages, isDataIds, sources, dataIdLengths, dataIdBegins} from '@/utils/constant'
export default {
    name: "moSetParameterS",
    data () {
      return {
            title:"操作",
            visible: false,
            ...
            this.$refs.ruleForm.validate((valid, err) => {
                if (valid){
                    try{
                        ...
                        typeParams.text = {isPackagesText,isDataIdsText,sourcesText,multiDataFrameFormatsText,multiRadioFrameFormatsText,frameFormatsText};
...
<style lang="scss">
.plugins-set-parametarrealtime-modal{
    .list-0{
        display:flex;
        flex-wrap: wrap;
        .item-0{
