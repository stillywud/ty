<template>
    <a-modal
      ...
      style="top: 20px;"
      :width="width"
      :visible="addDialogPack"
      @ok="handleSubmitpack"
      @cancel="closeDialog"
      wrapClassName="plugins-set-thing-modal"
    >
...
import {frameFormats,pgnIds,highBytes,setStates, isDataIds, eventTypes,happenConditions,  dataIdLengths, dataIdBegins} from '@/utils/constant'
export default {
    name:"moSetThingInfoT",
    props:[
        "addDialogPack",
        "packFormCopy"
    ],
    data(){
        return {
            ...
            packRules:{
              ...
              paramLength:[{required: false,trigger: "blur",validator:false}],
    ...
    watch:{
      ...
      if(o.hasOwnProperty("key")){
          ...
          this.packForm = packFormCopy;
        }
        console.log(o,v,'this.packRules')
