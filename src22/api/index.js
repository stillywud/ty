...
/** 查询字典 */
export const getDictList = (params) => getAction('https://www.fastmock.site/mock/43590fe9e1a9a3af3dc043ffe4661782/dx/api/confirmOrderPage', params)//getAction('/sys/dict/list', params)
...
/** 查询对象字典 **/
export const getDictObjList = (params) => getAction('https://www.fastmock.site/mock/43590fe9e1a9a3af3dc043ffe4661782/dx/api/confirmOrderPage', params)
...
export const getDictObjItems = (params) => {
    ...
    return getAction(`https://www.fastmock.site/mock/43590fe9e1a9a3af3dc043ffe4661782/dx/api/addShoppingCart`, params).then(res => {
        if (res.success) {
            dictObjCacheMap[params.code] = res.result.map(item => ({ value: item.value, label: item.text }))
            return Promise.resolve(dictObjCacheMap[params.code])
        } else {
...
export const getDictItems = (params) => {
    ...
    // /sys/dict/getDictItems/${params.code}
    return getAction(`https://www.fastmock.site/mock/43590fe9e1a9a3af3dc043ffe4661782/dx/api/modifiedNum`, params).then(res => {
        if (res.success) {
...
const getTransitURL = url => 'https://www.fastmock.site/mock/43590fe9e1a9a3af3dc043ffe4661782/dx/api/uploadImage'//`/sys/common/transitRESTful?url=${encodeURIComponent(url)}`
